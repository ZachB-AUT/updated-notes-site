# Troubleshooting for Electronics Project
...
We do not know why this works, only that it does most of the time. Please follow these steps as closely as possible.
...
6.  Press “remove”.
7.  Press “Install”.
8.  Open the [K drive libraries path](http://localhost:6384/docs/Eproj/troubleshooting.html#altium-libraries-path).
...
For a file to be properly included in an Altium project, it must meet three criteria:
...
Once that is done, right click on the project and click “Add existing to project”

![](../../assets/Add_Existing_To_Project.png)

Select the new file, and press “Open”.  

Ensure the file icon does not have an arrow on it like this icon: ![](../../assets/BRUH.png) If it does, you need to go through the “Add existing to project” step again. Then, remove the old referenced file. Ensure you press “Exclude from project” instead of deleting it, to make sure that you can recover from mistakes on this step.
