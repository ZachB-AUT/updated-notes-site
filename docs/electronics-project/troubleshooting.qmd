...
That being said, the following are quick guides on solving common problems. Try these first.
:::
...
We will use a set of libraries in the K: drive, which is a network drive common to all engineering computers at AUT.
...
For projects one and two, you will use `2026S2.IntLib`.

For reinstalling the altium libraries as described in [fixing the lastconnection.data error](#how-to-fix-the-lastconnection.data-error), use the libraries in the `AltiumLibraries\Altium Libraries` path.
